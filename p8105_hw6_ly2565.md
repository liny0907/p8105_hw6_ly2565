...
Produce an estimate of r squared for each bootstrap group and plot the
...
```
    ...
    ## # A tibble: 5,000 × 4
    ##    .id   beta0 beta1 log_beta0_beta1
    ##    <chr> <dbl> <dbl>           <dbl>
...
<img src="p8105_hw6_ly2565_files/figure-gfm/unnamed-chunk-12-1.png" width="90%" />
